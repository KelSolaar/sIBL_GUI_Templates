...
cd ../Maya
zip -r ../../../releases/repository/templates/Maya_Arnold_Standard.zip Maya_Arnold_Standard -xi "./Maya_Arnold_Standard/help/Maya_Arnold_Standard Template Manual"
...
cd ../Softimage
zip -r ../../../releases/repository/templates/Softimage_Arnold_Dome_Light.zip Softimage_Arnold_Dome_Light -xi "./Softimage_Arnold_Dome_Light/help/Softimage_Arnold_Dome_Light Template Manual"
zip -r ../../../releases/repository/templates/Softimage_Arnold_Lightsmith.zip Softimage_Arnold_Lightsmith -xi "./Softimage_Arnold_Lightsmith/help/Softimage_Arnold_Lightsmith Template Manual"
zip -r ../../../releases/repository/templates/Softimage_Arnold_Standard.zip Softimage_Arnold_Standard -xi "./Softimage_Arnold_Standard/help/Softimage_Arnold_Standard Template Manual"
...
cd ../XSI
zip -r ../../../releases/repository/templates/XSI_Arnold_Dome_Light.zip XSI_Arnold_Dome_Light -xi "./XSI_Arnold_Dome_Light/help/XSI_Arnold_Dome_Light Template Manual"
zip -r ../../../releases/repository/templates/XSI_Arnold_Standard.zip XSI_Arnold_Standard -xi "./XSI_Arnold_Standard/help/XSI_Arnold_Standard Template Manual"
